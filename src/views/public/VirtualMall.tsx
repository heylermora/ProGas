    ...
    <PublicPage maxW="1280px">
      ...
      <Box bg={panelBg} borderRadius={{ base: '20px', md: '28px' }} p={{ base: '12px', md: '22px' }} boxShadow="lg" mb="22px" overflow="hidden">
        ...
        <Box display="block">
          ...
          <Stack mt="12px" px={{ base: '14px', md: '18px' }} py="12px" borderRadius="14px" bg="navy.800" color="white" align="center" textAlign="center" spacing="2"><Text fontSize="10px" letterSpacing=".08em" color="cyan.200" fontWeight="900">DESTINO ACTUAL</Text><Text fontSize={{ base: 'md', md: 'lg' }} fontWeight="800">{selectedCategory || 'Plaza central'}</Text><Text fontSize="xs" color="whiteAlpha.800">Tocá otra estación para viajar.</Text></Stack>
        </Box>
